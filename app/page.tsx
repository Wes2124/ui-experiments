...
export const metadata: Metadata = {
  title: "Pointer AI - Trading Dashboard",
  description: "Advanced AI-powered trading analytics and market insights",
}
                  ...
                  <div className="flex-1 flex gap-3">
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <div className="text-[13px] text-muted-foreground/72 dark:text-muted-foreground/64 uppercase font-medium">
                        1 Year <span className="text-muted-foreground/40">·</span> PRC{" "}
