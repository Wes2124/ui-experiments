"use client"
import { BarChart, Bar, XAxis, YAxis, Cell, CartesianGrid, ReferenceLine, type TooltipProps } from "recharts"
...
function CandlestickChart() {
  console.log("[v0] CandlestickChart rendering with data length:", data.length)
  ...
  console.log("[v0] Chart domain:", { minValue, maxValue })
            ...
            <ReferenceLine
              ...
              label={({ viewBox }) => (
                <g transform={`translate(${viewBox.x + viewBox.width + 5},${viewBox.y})`}>
                  <rect x={-2} y={-10} width={50} height={20} fill={isGrowing ? "#10b981" : "#ef4444"} rx={4} />
