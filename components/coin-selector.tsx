  ...
  return (
    <div>
      <Popover open={open} onOpenChange={setOpen}>
            ...
            {value ? (
              <span className="flex min-w-0 items-center gap-2">
                {(() => {
                  ...
                  return (
                    <>
                      <img src={selectedCoin?.icon || "/placeholder.svg"} alt={selectedCoin?.name} className="size-5" />
        ...
        <PopoverContent className="max-w-48 min-w-[var(--radix-popper-anchor-width)] p-0" align="end">
          <Command
            filter={(value, search) => {
              if (!search) return 1
              ...
              <CommandGroup className="p-1">
                {coins.map((coin) => (
                  ...
                  >
                    ...
                    {value === coin.value && <CheckIcon size={16} className="ms-auto text-muted-foreground/80" />}
                  </CommandItem>
                ))}
              </CommandGroup>
            </CommandList>
